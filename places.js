 ...
 */;
 ...
 exports.places = {
   ...
   relativeURL: '/maps/api/place/textsearch/json',
   validator: v.object({
 ...
 exports.placesRadar = {
   ...
   baseURL: 'https://maps.googleapis.com/',
   relativeURL: '/maps/api/place/radarsearch/json',
   validator: v.object({
     location: utils.latLng,
     radius: v.number,
     language: v.optional(v.string),
 ...
 exports.place = {
   ...
   baseURL: 'https://maps.googleapis.com/',
   relativeURL: '/maps/api/place/details/json',
   validator: v.object({
     placeid: v.string,
     language: v.optional(v.string),
     retryOptions: v.optional(utils.retryOptions),
 ...
 exports.placesPhoto = {
   ...
   baseURL: 'https://maps.googleapis.com/',
   relativeURL: '/maps/api/place/photo',
   validator: v.object({
 ...
 exports.placesAutoComplete = {
   ...
   baseURL: 'https://maps.googleapis.com/',
   relativeURL: '/maps/api/place/autocomplete/json',
   validator: v.object({
     input: v.string,
 ...
 exports.placesQueryAutoComplete = {
   ...
   baseURL: 'https://maps.googleapis.com/',
   relativeURL: '/maps/api/place/queryautocomplete/json',
   validator: v.object({
     input: v.string,
     offset: v.optional(v.number),
     location: v.optional(utils.latLng),
